...
def callWeather():
    ...
    day2 = 'Date: ' + date_array[0] + ' 12:00, ' + 'Temperature: ' + str(temperatureArr[1]) + \
        ", " + weatherArr[1]

    day3 = 'Date: ' + date_array[0] + ' 12:00, ' + 'Temperature: ' + str(temperatureArr[2]) + \
        ", " + weatherArr[2]

    day4 = 'Date: ' + date_array[0] + ' 12:00, ' + 'Temperature: ' + str(temperatureArr[3]) + \
        ", " + weatherArr[3]

    day5 = 'Date: ' + date_array[0] + ' 12:00, ' + 'Temperature: ' + str(temperatureArr[4]) + \
        ", " + weatherArr[4]
    msg = day1 + '\n' + day2 + '\n' + day3 + '\n' + day4 + '\n' + day5
